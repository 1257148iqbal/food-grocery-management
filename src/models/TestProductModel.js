...
/*
    This model is same as product model. It is created to upload huge number of products
    of a shop using excel file so that data of products collection is not altered.
    
    localhost:5001/admin/product/upload-shop-product-excel
*/
...
module.exports = mongoose.model('testproducts', testProductSchema);
